...
namespace PowerSystem
{
	...
	public:
		...
		void FromMemory(ExBus **buses, int bun, ExBranch ** branches, int bran);
	...
	public:
		...
		virtual void InitBaBFromMemory(Bus **buses, int bun, Branch ** branches, int bran);
		...
		virtual void ToMemory(ExBus ** buses);
	protected:
		BusAndBranch BAB;
